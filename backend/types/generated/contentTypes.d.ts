...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Navigation menus with translation support';
    displayName: 'Menu';
    pluralName: 'menus';
    singularName: 'menu';
  };
  ...
  attributes: {
    ...
    menuItems: Schema.Attribute.Component<'menu.menu-item', true> &
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<['page-hierarchy.content-section']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiRedirectRedirect extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Redirects settings to be used in the frontend';
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['permanent', 'temporary']> & Schema.Attribute.DefaultTo<'permanent'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}

export interface ApiSiteOptionSiteOption extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    footerMenus: Schema.Attribute.Relation<'oneToMany', 'api::menu.menu'>;
    headerMenu: Schema.Attribute.Relation<'oneToOne', 'api::menu.menu'>;
    homepage: Schema.Attribute.Relation<'oneToOne', 'api::page.page'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::site-option.site-option'>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
